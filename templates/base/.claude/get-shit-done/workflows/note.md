...
- **Global scope**: `/Users/abc/Desktop/ResearchAI/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/abc/Desktop/ResearchAI/.claude/notes/`)
...
2. Glob `/Users/abc/Desktop/ResearchAI/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/abc/Desktop/ResearchAI/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/abc/Desktop/ResearchAI/.claude/notes/` — works in any directory
