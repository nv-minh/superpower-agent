...
function buildCrossRuntimeInstructions() {
...
function buildGeminiInstructions() {
...
function createSharedBridgeDocs(targetDir, runtimes, force) {
...
function createCodexAdapter(targetDir, force) {
...
function createCursorAdapter(targetDir, force) {
...
function createOpenCodeAdapter(targetDir, force) {
...
function createGeminiAdapter(targetDir, force) {
    for (const spec of FAD_COMMAND_SPECS) {
...
function createCopilotAdapter(targetDir, force) {
...
function buildWindsurfWorkflow(spec) {
...
function createWindsurfAdapter(targetDir, force) {
...
function createAntigravityAdapter(targetDir, force) {
...
function installRuntimeAdapters(targetDir, runtimes, force) {
